...
def build_ivf_flat_index(dataset, index_params, print_info=False):
    if print_info:
...
def search_ivf_flat(index, queries, search_params, k, print_info=False):
    if print_info:
...
def main():
    ...
    search_ivf_flat(index, queries, search_params, K, print_info=True)
